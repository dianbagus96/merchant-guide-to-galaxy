...
mini program to solve merchant guide to galaxy algorithm using Golang
...
![alt text](https://github.com/dianbagus96/merchant-guide-to-galaxy/blob/master/flow_merchant_galaxy_logic.jpg)
